...
<%@ page import="service.ReviewManager" %>
<%@ page import="dto.ReviewDisplayDto" %>
...
<body>
    ...
    <%
        ...
        List<ReviewDisplayDto> reviews = ReviewManager.getReviewsForCategory(categoryName);
        Map<String, Object> summary = ReviewManager.getReviewSummaryForCategory(categoryName);
